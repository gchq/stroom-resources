...
STROOM_ANNOTATIONS_UI_SSL_CERTIFICATE=${NGINX_SSL_CERTIFICATE}
STROOM_ANNOTATIONS_UI_SSL_CERTIFICATE_KEY=${NGINX_SSL_CERTIFICATE_KEY}
STROOM_ANNOTATIONS_UI_SSL_CLIENT_CERTIFICATE=${NGINX_SSL_CLIENT_CERTIFICATE}
...
STROOM_QUERY_ELASTIC_UI_URL=${STROOM_ELASTIC_UI_ACTIVE_SCHEME}://${STROOM_QUERY_ELASTIC_UI_HOST}:${STROOM_QUERY_ELASTIC_UI_ACTIVE_PORT}
STROOM_QUERY_ELASTIC_UI_SSL_CERTIFICATE=${NGINX_SSL_CERTIFICATE}
STROOM_QUERY_ELASTIC_UI_SSL_CERTIFICATE_KEY=${NGINX_SSL_CERTIFICATE_KEY}
STROOM_QUERY_ELASTIC_UI_SSL_CLIENT_CERTIFICATE=${NGINX_SSL_CLIENT_CERTIFICATE}
