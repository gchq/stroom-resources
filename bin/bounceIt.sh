...
LOCAL_HOST_NAMES="kafka hbase stroom-auth-service stroom-auth-ui stroom-annotations-service stroom-annotations-ui stroom-query-elastic-service stroom-query-elastic-ui"
