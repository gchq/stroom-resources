# Differences between `stroom-stacks-v6.0-beta.31` and `stroom-stacks-v6.0-beta.34`
...
## Variables that occur more than once within the `stroom-stacks-v6.0-beta.31` env file
...
From: ./build/stroom-stacks-v6.0-beta.31/stroom_core/volumes/nginx/conf/nginx.conf.template
...
@@ -466,7 +466,7 @@
         ...
         location ~ /stroom$ {
-             return 302 https://${STROOM_HOST}/stroom/ui;
