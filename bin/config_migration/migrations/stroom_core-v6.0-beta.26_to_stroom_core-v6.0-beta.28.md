# Differences between stroom_core-v6.0-beta.26 and stroom_core-v6.0-beta.28
...
STROOM_PROXY_TAG has changed from "v6.0-beta.26" to "v6.0-beta.28"
STROOM_TAG has changed from "v6.0-beta.26" to "v6.0-beta.28"
STROOM_NGINX_TAG has changed from "v1.0-alpha.14" to "v1.0-alpha.15"

## Variables that occur more than once within the stroom_core-v6.0-beta.26 env file
