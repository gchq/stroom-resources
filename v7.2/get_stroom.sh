...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.2-alpha.6/stroom-stacks-v6.0-beta.28-9/; s/v7.2-alpha.6/v6.0-beta.28-9/; s/255fad9ce2578ea9e62c775efaed0b1a6e13911a1ae9ea13effed53426ab9829  stroom_core_test-v7.2-alpha.6.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.2-alpha.6"
  local -r stack_version="v7.2-alpha.6"
  local -r hash_file_contents="255fad9ce2578ea9e62c775efaed0b1a6e13911a1ae9ea13effed53426ab9829  stroom_core_test-v7.2-alpha.6.tar.gz"
