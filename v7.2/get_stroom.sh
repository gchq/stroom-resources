...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.2-beta.41-2/stroom-stacks-v6.0-beta.28-9/; s/v7.2-beta.41-2/v6.0-beta.28-9/; s/2b512e80be1b791272a7c8a185aace34a1613e777c7485a5eddc615187223b8b  stroom_core_test-v7.2-beta.41-2.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.2-beta.41-2"
  local -r stack_version="v7.2-beta.41-2"
  local -r hash_file_contents="2b512e80be1b791272a7c8a185aace34a1613e777c7485a5eddc615187223b8b  stroom_core_test-v7.2-beta.41-2.tar.gz"
