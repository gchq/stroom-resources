...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.2-beta.42/stroom-stacks-v6.0-beta.28-9/; s/v7.2-beta.42/v6.0-beta.28-9/; s/e92d4bc51699ae96026bd3fbbaf75f64d1f328e9ba6bf144da16ad50c4599e2a  stroom_core_test-v7.2-beta.42.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.2-beta.42"
  local -r stack_version="v7.2-beta.42"
  local -r hash_file_contents="e92d4bc51699ae96026bd3fbbaf75f64d1f328e9ba6bf144da16ad50c4599e2a  stroom_core_test-v7.2-beta.42.tar.gz"
