...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.2-beta.43/stroom-stacks-v6.0-beta.28-9/; s/v7.2-beta.43/v6.0-beta.28-9/; s/42fc2d689428228d78410d7009b82973b9d98597ee02b2f61c42d37db139f327  stroom_core_test-v7.2-beta.43.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.2-beta.43"
  local -r stack_version="v7.2-beta.43"
  local -r hash_file_contents="42fc2d689428228d78410d7009b82973b9d98597ee02b2f61c42d37db139f327  stroom_core_test-v7.2-beta.43.tar.gz"
