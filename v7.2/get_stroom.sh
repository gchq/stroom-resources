...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.2-beta.14/stroom-stacks-v6.0-beta.28-9/; s/v7.2-beta.14/v6.0-beta.28-9/; s/63026f953176b61f4861b6fa774e1a98f0b9ed9dda72cb0a98076ce4b3ea68da  stroom_core_test-v7.2-beta.14.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.2-beta.14"
  local -r stack_version="v7.2-beta.14"
  local -r hash_file_contents="63026f953176b61f4861b6fa774e1a98f0b9ed9dda72cb0a98076ce4b3ea68da  stroom_core_test-v7.2-beta.14.tar.gz"
