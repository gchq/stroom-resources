...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10-beta.12/stroom-stacks-v6.0-beta.28-9/; s/v7.10-beta.12/v6.0-beta.28-9/; s/62287d47207f11f338d05551e7d553717281983cd9a82ce5fa267fa422b6581c  stroom_core_test-v7.10-beta.12.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10-beta.12"
  local -r stack_version="v7.10-beta.12"
  local -r hash_file_contents="62287d47207f11f338d05551e7d553717281983cd9a82ce5fa267fa422b6581c  stroom_core_test-v7.10-beta.12.tar.gz"
