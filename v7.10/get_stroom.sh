...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10.5/stroom-stacks-v6.0-beta.28-9/; s/v7.10.5/v6.0-beta.28-9/; s/9e36116e1abd7edd63e8644cd139683154792b88deb9ab3d9cd52d5ade7e869f  stroom_core_test-v7.10.5.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10.5"
  local -r stack_version="v7.10.5"
  local -r hash_file_contents="9e36116e1abd7edd63e8644cd139683154792b88deb9ab3d9cd52d5ade7e869f  stroom_core_test-v7.10.5.tar.gz"
