...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10.3/stroom-stacks-v6.0-beta.28-9/; s/v7.10.3/v6.0-beta.28-9/; s/2ab05cd6e57f1cbed958f4066516c1043f45d6b5c536f3c1c87029aec7b9aa54  stroom_core_test-v7.10.3.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10.3"
  local -r stack_version="v7.10.3"
  local -r hash_file_contents="2ab05cd6e57f1cbed958f4066516c1043f45d6b5c536f3c1c87029aec7b9aa54  stroom_core_test-v7.10.3.tar.gz"
