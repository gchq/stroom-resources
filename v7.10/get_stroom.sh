...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10.19/stroom-stacks-v6.0-beta.28-9/; s/v7.10.19/v6.0-beta.28-9/; s/d80d3540e47c4fdbe6e6953022b7d7aba3c441db7cd4cdbb2dd07bc1f86a95a9  stroom_core_test-v7.10.19.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10.19"
  local -r stack_version="v7.10.19"
  local -r hash_file_contents="d80d3540e47c4fdbe6e6953022b7d7aba3c441db7cd4cdbb2dd07bc1f86a95a9  stroom_core_test-v7.10.19.tar.gz"
