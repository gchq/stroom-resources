...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10.1/stroom-stacks-v6.0-beta.28-9/; s/v7.10.1/v6.0-beta.28-9/; s/7ae5d0e98eec3ac9a1b7003b8cd8b8fc9b6148511a11b89c0b597542725fb870  stroom_core_test-v7.10.1.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10.1"
  local -r stack_version="v7.10.1"
  local -r hash_file_contents="7ae5d0e98eec3ac9a1b7003b8cd8b8fc9b6148511a11b89c0b597542725fb870  stroom_core_test-v7.10.1.tar.gz"
