...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10.7/stroom-stacks-v6.0-beta.28-9/; s/v7.10.7/v6.0-beta.28-9/; s/5b2a9c3bdf349e7c8c7c2e70cf9b95ac88aa970a37a898cf4c09ccca6a468ecc  stroom_core_test-v7.10.7.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10.7"
  local -r stack_version="v7.10.7"
  local -r hash_file_contents="5b2a9c3bdf349e7c8c7c2e70cf9b95ac88aa970a37a898cf4c09ccca6a468ecc  stroom_core_test-v7.10.7.tar.gz"
