...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10-beta.9/stroom-stacks-v6.0-beta.28-9/; s/v7.10-beta.9/v6.0-beta.28-9/; s/919d6d5d52b740af767248da9be58faf7bc719fe358a5685b53f59332ee65d81  stroom_core_test-v7.10-beta.9.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10-beta.9"
  local -r stack_version="v7.10-beta.9"
  local -r hash_file_contents="919d6d5d52b740af767248da9be58faf7bc719fe358a5685b53f59332ee65d81  stroom_core_test-v7.10-beta.9.tar.gz"
