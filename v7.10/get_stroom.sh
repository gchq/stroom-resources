...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10.20/stroom-stacks-v6.0-beta.28-9/; s/v7.10.20/v6.0-beta.28-9/; s/8527d8346e75155e7281fa810e201a69cb1aaee9fd83829696a5b2d953d0c1e8  stroom_core_test-v7.10.20.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10.20"
  local -r stack_version="v7.10.20"
  local -r hash_file_contents="8527d8346e75155e7281fa810e201a69cb1aaee9fd83829696a5b2d953d0c1e8  stroom_core_test-v7.10.20.tar.gz"
