...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.10.4/stroom-stacks-v6.0-beta.28-9/; s/v7.10.4/v6.0-beta.28-9/; s/cbf6a35fdbe9c1e9efc66a1f2ea042ff6d17009671e94cb8745b0246abcb5820  stroom_core_test-v7.10.4.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.10.4"
  local -r stack_version="v7.10.4"
  local -r hash_file_contents="cbf6a35fdbe9c1e9efc66a1f2ea042ff6d17009671e94cb8745b0246abcb5820  stroom_core_test-v7.10.4.tar.gz"
