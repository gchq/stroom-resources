...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.7-beta.5-proxy-v7.0.37-2/stroom-stacks-v6.0-beta.28-9/; s/v7.7-beta.5-proxy-v7.0.37-2/v6.0-beta.28-9/; s/16efae24df6f77d26c1b5a7f50202b7dae748f63541d321dc8b694572014c384  stroom_core_test-v7.7-beta.5-proxy-v7.0.37-2.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.7-beta.5-proxy-v7.0.37-2"
  local -r stack_version="v7.7-beta.5-proxy-v7.0.37-2"
  local -r hash_file_contents="16efae24df6f77d26c1b5a7f50202b7dae748f63541d321dc8b694572014c384  stroom_core_test-v7.7-beta.5-proxy-v7.0.37-2.tar.gz"
