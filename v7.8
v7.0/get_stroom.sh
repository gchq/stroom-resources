...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.8-reporting.2-proxy-v7.0.37/stroom-stacks-v6.0-beta.28-9/; s/v7.8-reporting.2-proxy-v7.0.37/v6.0-beta.28-9/; s/be3aac762e0e6f95dd1f502712197504aa5cdd7e5d67635ead6f3a29e86059d2  stroom_core_test-v7.8-reporting.2-proxy-v7.0.37.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.8-reporting.2-proxy-v7.0.37"
  local -r stack_version="v7.8-reporting.2-proxy-v7.0.37"
  local -r hash_file_contents="be3aac762e0e6f95dd1f502712197504aa5cdd7e5d67635ead6f3a29e86059d2  stroom_core_test-v7.8-reporting.2-proxy-v7.0.37.tar.gz"
