...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.8-reporting.3-proxy-v7.0.37/stroom-stacks-v6.0-beta.28-9/; s/v7.8-reporting.3-proxy-v7.0.37/v6.0-beta.28-9/; s/116e17aa0f4d03ef7a819727ea719637d2a480eb5eea22809b830f6b7101612a  stroom_core_test-v7.8-reporting.3-proxy-v7.0.37.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.8-reporting.3-proxy-v7.0.37"
  local -r stack_version="v7.8-reporting.3-proxy-v7.0.37"
  local -r hash_file_contents="116e17aa0f4d03ef7a819727ea719637d2a480eb5eea22809b830f6b7101612a  stroom_core_test-v7.8-reporting.3-proxy-v7.0.37.tar.gz"
