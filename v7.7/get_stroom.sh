...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.7-beta.12/stroom-stacks-v6.0-beta.28-9/; s/v7.7-beta.12/v6.0-beta.28-9/; s/f35b8546c1afd01333387abfdbde16198847ec7d586fc4d7139e4189d9a54e10  stroom_core_test-v7.7-beta.12.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.7-beta.12"
  local -r stack_version="v7.7-beta.12"
  local -r hash_file_contents="f35b8546c1afd01333387abfdbde16198847ec7d586fc4d7139e4189d9a54e10  stroom_core_test-v7.7-beta.12.tar.gz"
