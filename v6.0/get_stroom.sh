...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v6.0.36-12/stroom-stacks-v6.0-beta.28-9/; s/v6.0.36-12/v6.0-beta.28-9/; s/c6d90357a17e5793113c4640b72a9b2317909ac13bb3fcfb4d46a6b5c81adc0a  stroom_core_test-v6.0.36-12.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v6.0.36-12"
  local -r stack_version="v6.0.36-12"
  local -r hash_file_contents="c6d90357a17e5793113c4640b72a9b2317909ac13bb3fcfb4d46a6b5c81adc0a  stroom_core_test-v6.0.36-12.tar.gz"
