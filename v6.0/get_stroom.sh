...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v6.0.36-11/stroom-stacks-v6.0-beta.28-9/; s/v6.0.36-11/v6.0-beta.28-9/; s/eef8bc337beeddf8c2fce02a58993855e91a31099788c5dfda0be1c8d82fe509  stroom_core_test-v6.0.36-11.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v6.0.36-11"
  local -r stack_version="v6.0.36-11"
  local -r hash_file_contents="eef8bc337beeddf8c2fce02a58993855e91a31099788c5dfda0be1c8d82fe509  stroom_core_test-v6.0.36-11.tar.gz"
