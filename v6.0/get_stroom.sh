...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v6.0.36-13/stroom-stacks-v6.0-beta.28-9/; s/v6.0.36-13/v6.0-beta.28-9/; s/795dd2a5b5439f7f50e8dd86242b68ec543365aea71a15962c083ceaee0f5412  stroom_core_test-v6.0.36-13.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v6.0.36-13"
  local -r stack_version="v6.0.36-13"
  local -r hash_file_contents="795dd2a5b5439f7f50e8dd86242b68ec543365aea71a15962c083ceaee0f5412  stroom_core_test-v6.0.36-13.tar.gz"
