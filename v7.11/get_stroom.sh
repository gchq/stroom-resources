...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.11-beta.10/stroom-stacks-v6.0-beta.28-9/; s/v7.11-beta.10/v6.0-beta.28-9/; s/a7985b45eca18a5344e957597ac66f666301f343a1ef6966560bdcc26da50c23  stroom_core_test-v7.11-beta.10.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.11-beta.10"
  local -r stack_version="v7.11-beta.10"
  local -r hash_file_contents="a7985b45eca18a5344e957597ac66f666301f343a1ef6966560bdcc26da50c23  stroom_core_test-v7.11-beta.10.tar.gz"
