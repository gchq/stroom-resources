...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.11-beta.19-gwt-sourcemaps/stroom-stacks-v6.0-beta.28-9/; s/v7.11-beta.19-gwt-sourcemaps/v6.0-beta.28-9/; s/e508c6f3ad61d78861882d9b164413e98375175630bf894db7f2e6c547cc7505  stroom_core_test-v7.11-beta.19-gwt-sourcemaps.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.11-beta.19-gwt-sourcemaps"
  local -r stack_version="v7.11-beta.19-gwt-sourcemaps"
  local -r hash_file_contents="e508c6f3ad61d78861882d9b164413e98375175630bf894db7f2e6c547cc7505  stroom_core_test-v7.11-beta.19-gwt-sourcemaps.tar.gz"
