...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.11.4/stroom-stacks-v6.0-beta.28-9/; s/v7.11.4/v6.0-beta.28-9/; s/f7701a4b7224a42682fbd98f87e6c65824e5f68ef7031b4a0a4b0e9e16f622ae  stroom_core_test-v7.11.4.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.11.4"
  local -r stack_version="v7.11.4"
  local -r hash_file_contents="f7701a4b7224a42682fbd98f87e6c65824e5f68ef7031b4a0a4b0e9e16f622ae  stroom_core_test-v7.11.4.tar.gz"
