...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.11-beta.21/stroom-stacks-v6.0-beta.28-9/; s/v7.11-beta.21/v6.0-beta.28-9/; s/8a9a720968ef1d11fa818e9f9812f2dc74b7fdcf119daaea862ad3a468586d6a  stroom_core_test-v7.11-beta.21.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.11-beta.21"
  local -r stack_version="v7.11-beta.21"
  local -r hash_file_contents="8a9a720968ef1d11fa818e9f9812f2dc74b7fdcf119daaea862ad3a468586d6a  stroom_core_test-v7.11-beta.21.tar.gz"
