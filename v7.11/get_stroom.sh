...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.11-pathways-beta/stroom-stacks-v6.0-beta.28-9/; s/v7.11-pathways-beta/v6.0-beta.28-9/; s/a69f3501346d96a89eaba6f96279f1ed2086ebd5c50588010307db645e2f5cd8  stroom_core_test-v7.11-pathways-beta.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.11-pathways-beta"
  local -r stack_version="v7.11-pathways-beta"
  local -r hash_file_contents="a69f3501346d96a89eaba6f96279f1ed2086ebd5c50588010307db645e2f5cd8  stroom_core_test-v7.11-pathways-beta.tar.gz"
