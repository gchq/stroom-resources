...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.14-beta.2/stroom-stacks-v6.0-beta.28-9/; s/v7.14-beta.2/v6.0-beta.28-9/; s/b9f98445cd8b9ef22ad51d311e5e8d491881609ee77ddd2d039fdd77b6ff8709  stroom_core_test-v7.14-beta.2.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.14-beta.2"
  local -r stack_version="v7.14-beta.2"
  local -r hash_file_contents="b9f98445cd8b9ef22ad51d311e5e8d491881609ee77ddd2d039fdd77b6ff8709  stroom_core_test-v7.14-beta.2.tar.gz"
