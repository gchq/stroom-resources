...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.9-beta.4-annotations2/stroom-stacks-v6.0-beta.28-9/; s/v7.9-beta.4-annotations2/v6.0-beta.28-9/; s/c3a68be2623e30f0bcbcceb6da528d537263e5cd738845684715f85124d20950  stroom_core_test-v7.9-beta.4-annotations2.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.9-beta.4-annotations2"
  local -r stack_version="v7.9-beta.4-annotations2"
  local -r hash_file_contents="c3a68be2623e30f0bcbcceb6da528d537263e5cd738845684715f85124d20950  stroom_core_test-v7.9-beta.4-annotations2.tar.gz"
