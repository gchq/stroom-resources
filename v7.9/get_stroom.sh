...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.9.0/stroom-stacks-v6.0-beta.28-9/; s/v7.9.0/v6.0-beta.28-9/; s/3df0146c100fd8e992a173f65f12dfeb37616391cff98baf1595eb4528d53517  stroom_core_test-v7.9.0.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.9.0"
  local -r stack_version="v7.9.0"
  local -r hash_file_contents="3df0146c100fd8e992a173f65f12dfeb37616391cff98baf1595eb4528d53517  stroom_core_test-v7.9.0.tar.gz"
