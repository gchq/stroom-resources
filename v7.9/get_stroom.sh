...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.9-beta.9/stroom-stacks-v6.0-beta.28-9/; s/v7.9-beta.9/v6.0-beta.28-9/; s/60f29292d7b530e42755ad26c1a11b0e6e18856d1ddb4f6fbbfa570b94ef7db4  stroom_core_test-v7.9-beta.9.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.9-beta.9"
  local -r stack_version="v7.9-beta.9"
  local -r hash_file_contents="60f29292d7b530e42755ad26c1a11b0e6e18856d1ddb4f6fbbfa570b94ef7db4  stroom_core_test-v7.9-beta.9.tar.gz"
