...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.9-beta.13/stroom-stacks-v6.0-beta.28-9/; s/v7.9-beta.13/v6.0-beta.28-9/; s/0362f793f7363d3a6048ba25177ed8e7618b77c1dfbef86616047703aaf11e2a  stroom_core_test-v7.9-beta.13.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.9-beta.13"
  local -r stack_version="v7.9-beta.13"
  local -r hash_file_contents="0362f793f7363d3a6048ba25177ed8e7618b77c1dfbef86616047703aaf11e2a  stroom_core_test-v7.9-beta.13.tar.gz"
