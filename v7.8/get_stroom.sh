...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.8-beta.17/stroom-stacks-v6.0-beta.28-9/; s/v7.8-beta.17/v6.0-beta.28-9/; s/e1ab175bb509bdceaf45dfcf371cfec8c7f45883b4c11d3e9b136fe32c0c8669  stroom_core_test-v7.8-beta.17.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.8-beta.17"
  local -r stack_version="v7.8-beta.17"
  local -r hash_file_contents="e1ab175bb509bdceaf45dfcf371cfec8c7f45883b4c11d3e9b136fe32c0c8669  stroom_core_test-v7.8-beta.17.tar.gz"
