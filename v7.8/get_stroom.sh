...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.8-planb-beta.9/stroom-stacks-v6.0-beta.28-9/; s/v7.8-planb-beta.9/v6.0-beta.28-9/; s/3728d859fb571ff91289cbe6bfa813fe9e864150fab2aec29597a1237b4ec722  stroom_core_test-v7.8-planb-beta.9.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.8-planb-beta.9"
  local -r stack_version="v7.8-planb-beta.9"
  local -r hash_file_contents="3728d859fb571ff91289cbe6bfa813fe9e864150fab2aec29597a1237b4ec722  stroom_core_test-v7.8-planb-beta.9.tar.gz"
