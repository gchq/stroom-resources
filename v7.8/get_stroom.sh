...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.8-beta.18/stroom-stacks-v6.0-beta.28-9/; s/v7.8-beta.18/v6.0-beta.28-9/; s/92bb41e3563a34463f1abfa79551d4efe38a5eda41917dc96a2b1ec26f09c7f8  stroom_core_test-v7.8-beta.18.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.8-beta.18"
  local -r stack_version="v7.8-beta.18"
  local -r hash_file_contents="92bb41e3563a34463f1abfa79551d4efe38a5eda41917dc96a2b1ec26f09c7f8  stroom_core_test-v7.8-beta.18.tar.gz"
