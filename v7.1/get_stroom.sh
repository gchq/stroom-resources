...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.1-beta.12-2/stroom-stacks-v6.0-beta.28-9/; s/v7.1-beta.12-2/v6.0-beta.28-9/; s/8c0bf21765cb0b00ca8da05aee21c36f7a1aef2d4c4784dec347dbfd10f38e91  stroom_core_test-v7.1-beta.12-2.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.1-beta.12-2"
  local -r stack_version="v7.1-beta.12-2"
  local -r hash_file_contents="8c0bf21765cb0b00ca8da05aee21c36f7a1aef2d4c4784dec347dbfd10f38e91  stroom_core_test-v7.1-beta.12-2.tar.gz"
