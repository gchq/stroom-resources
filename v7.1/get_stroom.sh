...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.1-beta.20/stroom-stacks-v6.0-beta.28-9/; s/v7.1-beta.20/v6.0-beta.28-9/; s/f523340d0f43b2a0962583a569c69757a6d5fb59a5759a399cb8ae7f2a005768  stroom_core_test-v7.1-beta.20.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.1-beta.20"
  local -r stack_version="v7.1-beta.20"
  local -r hash_file_contents="f523340d0f43b2a0962583a569c69757a6d5fb59a5759a399cb8ae7f2a005768  stroom_core_test-v7.1-beta.20.tar.gz"
