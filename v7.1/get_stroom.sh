...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.1-beta.9/stroom-stacks-v6.0-beta.28-9/; s/v7.1-beta.9/v6.0-beta.28-9/; s/80501ebd1cb94ae938ef23c955cd46690a2c6e2aa071e0a90f6fe344f4a8f97b  stroom_core_test-v7.1-beta.9.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.1-beta.9"
  local -r stack_version="v7.1-beta.9"
  local -r hash_file_contents="80501ebd1cb94ae938ef23c955cd46690a2c6e2aa071e0a90f6fe344f4a8f97b  stroom_core_test-v7.1-beta.9.tar.gz"
