...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.1-beta.17/stroom-stacks-v6.0-beta.28-9/; s/v7.1-beta.17/v6.0-beta.28-9/; s/292bce0dfd16ddbc7db43c89f5e12ede96c6fe78140f262ae382bbed8d5cc5c4  stroom_core_test-v7.1-beta.17.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.1-beta.17"
  local -r stack_version="v7.1-beta.17"
  local -r hash_file_contents="292bce0dfd16ddbc7db43c89f5e12ede96c6fe78140f262ae382bbed8d5cc5c4  stroom_core_test-v7.1-beta.17.tar.gz"
