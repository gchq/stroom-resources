...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.1-beta.18/stroom-stacks-v6.0-beta.28-9/; s/v7.1-beta.18/v6.0-beta.28-9/; s/256d52d79e0d7129390a5dae7008f0710909d52d3e5d3a7d6334852ba64fe17b  stroom_core_test-v7.1-beta.18.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.1-beta.18"
  local -r stack_version="v7.1-beta.18"
  local -r hash_file_contents="256d52d79e0d7129390a5dae7008f0710909d52d3e5d3a7d6334852ba64fe17b  stroom_core_test-v7.1-beta.18.tar.gz"
