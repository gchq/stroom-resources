...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.137/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.137/v6.0-beta.28-9/; s/d4e6293e6422df2eca9fa57d39bcab9e20d0a6d1aa845b096d319ceb9be793a3  stroom_core_test-v7.0-beta.137.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.137"
  local -r stack_version="v7.0-beta.137"
  local -r hash_file_contents="d4e6293e6422df2eca9fa57d39bcab9e20d0a6d1aa845b096d319ceb9be793a3  stroom_core_test-v7.0-beta.137.tar.gz"
