...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.178/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.178/v6.0-beta.28-9/; s/0b28f51041cf2e6463abee21263de7a84e555311cba2fa5322dd66bf6ee0b6a2  stroom_core_test-v7.0-beta.178.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.178"
  local -r stack_version="v7.0-beta.178"
  local -r hash_file_contents="0b28f51041cf2e6463abee21263de7a84e555311cba2fa5322dd66bf6ee0b6a2  stroom_core_test-v7.0-beta.178.tar.gz"
