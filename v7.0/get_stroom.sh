...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.173/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.173/v6.0-beta.28-9/; s/e0de894d11c162973dac29bfd0793b0fe5f6846fe2dd10e3ecc1243cc0440d82  stroom_core_test-v7.0-beta.173.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.173"
  local -r stack_version="v7.0-beta.173"
  local -r hash_file_contents="e0de894d11c162973dac29bfd0793b0fe5f6846fe2dd10e3ecc1243cc0440d82  stroom_core_test-v7.0-beta.173.tar.gz"
