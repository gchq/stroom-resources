...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0.25/stroom-stacks-v6.0-beta.28-9/; s/v7.0.25/v6.0-beta.28-9/; s/056656780289d69669c9cfcdf659b3f006620c4f5369a9da397be024eca0b613  stroom_core_test-v7.0.25.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0.25"
  local -r stack_version="v7.0.25"
  local -r hash_file_contents="056656780289d69669c9cfcdf659b3f006620c4f5369a9da397be024eca0b613  stroom_core_test-v7.0.25.tar.gz"
