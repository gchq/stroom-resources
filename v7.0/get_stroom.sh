...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.209/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.209/v6.0-beta.28-9/; s/b3e270192f8695199470be42a5613082ccdd5e84c2804573adff8ca2994e34a5  stroom_core_test-v7.0-beta.209.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.209"
  local -r stack_version="v7.0-beta.209"
  local -r hash_file_contents="b3e270192f8695199470be42a5613082ccdd5e84c2804573adff8ca2994e34a5  stroom_core_test-v7.0-beta.209.tar.gz"
