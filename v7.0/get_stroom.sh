...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0.23-beta.1/stroom-stacks-v6.0-beta.28-9/; s/v7.0.23-beta.1/v6.0-beta.28-9/; s/aa7f9c722cf743a409df57aae532986b88acd5c9df7f4bb52d1f5405295c256b  stroom_core_test-v7.0.23-beta.1.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0.23-beta.1"
  local -r stack_version="v7.0.23-beta.1"
  local -r hash_file_contents="aa7f9c722cf743a409df57aae532986b88acd5c9df7f4bb52d1f5405295c256b  stroom_core_test-v7.0.23-beta.1.tar.gz"
