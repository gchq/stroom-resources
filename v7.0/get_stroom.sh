...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.216/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.216/v6.0-beta.28-9/; s/06d1788ac0f0e0cf890351db2d27197a519fc9b8dd83fe57e85c0ba8abe370c6  stroom_core_test-v7.0-beta.216.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.216"
  local -r stack_version="v7.0-beta.216"
  local -r hash_file_contents="06d1788ac0f0e0cf890351db2d27197a519fc9b8dd83fe57e85c0ba8abe370c6  stroom_core_test-v7.0-beta.216.tar.gz"
