...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.146/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.146/v6.0-beta.28-9/; s/f6d14c5dfc11cc6a8f2b5669e2538e20f8e1545924f1c5fb3d4f518f379890cc  stroom_core_test-v7.0-beta.146.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.146"
  local -r stack_version="v7.0-beta.146"
  local -r hash_file_contents="f6d14c5dfc11cc6a8f2b5669e2538e20f8e1545924f1c5fb3d4f518f379890cc  stroom_core_test-v7.0-beta.146.tar.gz"
