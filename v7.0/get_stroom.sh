...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.134/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.134/v6.0-beta.28-9/; s/a8f7df41c32ac22d6ad3f7bffd87eccac4e7dbe489439f5e5463b7318a8a7a5a  stroom_core_test-v7.0-beta.134.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.134"
  local -r stack_version="v7.0-beta.134"
  local -r hash_file_contents="a8f7df41c32ac22d6ad3f7bffd87eccac4e7dbe489439f5e5463b7318a8a7a5a  stroom_core_test-v7.0-beta.134.tar.gz"
