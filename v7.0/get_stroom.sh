...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.169/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.169/v6.0-beta.28-9/; s/d23870059e3f86fda0bf8e05c9cb512b7174f5aa6227d2a33307f1b2fd3ac7b0  stroom_core_test-v7.0-beta.169.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.169"
  local -r stack_version="v7.0-beta.169"
  local -r hash_file_contents="d23870059e3f86fda0bf8e05c9cb512b7174f5aa6227d2a33307f1b2fd3ac7b0  stroom_core_test-v7.0-beta.169.tar.gz"
