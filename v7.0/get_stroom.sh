...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0.10/stroom-stacks-v6.0-beta.28-9/; s/v7.0.10/v6.0-beta.28-9/; s/33aca306effff29e9b06538bee3b93e0784873355b1b98eec643336dcd6d9f25  stroom_core_test-v7.0.10.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0.10"
  local -r stack_version="v7.0.10"
  local -r hash_file_contents="33aca306effff29e9b06538bee3b93e0784873355b1b98eec643336dcd6d9f25  stroom_core_test-v7.0.10.tar.gz"
