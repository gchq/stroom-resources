...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.206/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.206/v6.0-beta.28-9/; s/373f94ccfce78c25ec22683c3999d2a793c80249a5886d0864b326d1226a3202  stroom_core_test-v7.0-beta.206.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.206"
  local -r stack_version="v7.0-beta.206"
  local -r hash_file_contents="373f94ccfce78c25ec22683c3999d2a793c80249a5886d0864b326d1226a3202  stroom_core_test-v7.0-beta.206.tar.gz"
