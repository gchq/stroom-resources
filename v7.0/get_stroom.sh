...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0.3/stroom-stacks-v6.0-beta.28-9/; s/v7.0.3/v6.0-beta.28-9/; s/e315bb8886c293c3961a797ea357faa5124c68168eb626a6fd9eb5f3ae0bf5a2  stroom_core_test-v7.0.3.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0.3"
  local -r stack_version="v7.0.3"
  local -r hash_file_contents="e315bb8886c293c3961a797ea357faa5124c68168eb626a6fd9eb5f3ae0bf5a2  stroom_core_test-v7.0.3.tar.gz"
