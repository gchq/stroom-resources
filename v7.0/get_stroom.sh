...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.175/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.175/v6.0-beta.28-9/; s/3c9e7aa35ba71dfb1cde74417e0b9b21183b15487261326e27536116f04b2246  stroom_core_test-v7.0-beta.175.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.175"
  local -r stack_version="v7.0-beta.175"
  local -r hash_file_contents="3c9e7aa35ba71dfb1cde74417e0b9b21183b15487261326e27536116f04b2246  stroom_core_test-v7.0-beta.175.tar.gz"
