...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.160/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.160/v6.0-beta.28-9/; s/c8081ff4079c6bf07964d2ba989cf4da161eafe64d59c873ed22b10e4657cfc9  stroom_core_test-v7.0-beta.160.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.160"
  local -r stack_version="v7.0-beta.160"
  local -r hash_file_contents="c8081ff4079c6bf07964d2ba989cf4da161eafe64d59c873ed22b10e4657cfc9  stroom_core_test-v7.0-beta.160.tar.gz"
