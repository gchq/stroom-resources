...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.159/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.159/v6.0-beta.28-9/; s/0460551d0317dea695b3a7519ed9589d5ba7ea887b3a04b6afff510b635ea58f  stroom_core_test-v7.0-beta.159.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.159"
  local -r stack_version="v7.0-beta.159"
  local -r hash_file_contents="0460551d0317dea695b3a7519ed9589d5ba7ea887b3a04b6afff510b635ea58f  stroom_core_test-v7.0-beta.159.tar.gz"
