...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.207/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.207/v6.0-beta.28-9/; s/58d463415a36437096c173873a5bb0b96f905ef8fb93136728057ad42adce7ee  stroom_core_test-v7.0-beta.207.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.207"
  local -r stack_version="v7.0-beta.207"
  local -r hash_file_contents="58d463415a36437096c173873a5bb0b96f905ef8fb93136728057ad42adce7ee  stroom_core_test-v7.0-beta.207.tar.gz"
