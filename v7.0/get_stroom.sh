...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.204/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.204/v6.0-beta.28-9/; s/e3b8c00788ba00f2a3233def3346818afb876904f9ced1938cde74ba075feb28  stroom_core_test-v7.0-beta.204.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.204"
  local -r stack_version="v7.0-beta.204"
  local -r hash_file_contents="e3b8c00788ba00f2a3233def3346818afb876904f9ced1938cde74ba075feb28  stroom_core_test-v7.0-beta.204.tar.gz"
