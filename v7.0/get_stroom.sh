...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.142/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.142/v6.0-beta.28-9/; s/3118069faf19800f112e7ddf90e894db8a43d67ea5568d5afabca6a8d37bbd1e  stroom_core_test-v7.0-beta.142.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.142"
  local -r stack_version="v7.0-beta.142"
  local -r hash_file_contents="3118069faf19800f112e7ddf90e894db8a43d67ea5568d5afabca6a8d37bbd1e  stroom_core_test-v7.0-beta.142.tar.gz"
