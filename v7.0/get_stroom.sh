...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.211/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.211/v6.0-beta.28-9/; s/aa04887f879b406c9700a91749e73e4f9ce61d4777889367dd57b9a31e80042c  stroom_core_test-v7.0-beta.211.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.211"
  local -r stack_version="v7.0-beta.211"
  local -r hash_file_contents="aa04887f879b406c9700a91749e73e4f9ce61d4777889367dd57b9a31e80042c  stroom_core_test-v7.0-beta.211.tar.gz"
