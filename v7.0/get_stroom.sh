...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0.14/stroom-stacks-v6.0-beta.28-9/; s/v7.0.14/v6.0-beta.28-9/; s/d8ca4d5df5305d1314d12f11b6644afe77689fcae23d5a1abee38c52856f7352  stroom_core_test-v7.0.14.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0.14"
  local -r stack_version="v7.0.14"
  local -r hash_file_contents="d8ca4d5df5305d1314d12f11b6644afe77689fcae23d5a1abee38c52856f7352  stroom_core_test-v7.0.14.tar.gz"
