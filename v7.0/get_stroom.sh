...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0-beta.192/stroom-stacks-v6.0-beta.28-9/; s/v7.0-beta.192/v6.0-beta.28-9/; s/53ed1a3149454b8d2825ac0caa9e57f81282241f9180a397b4a9c321aa36d366  stroom_core_test-v7.0-beta.192.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0-beta.192"
  local -r stack_version="v7.0-beta.192"
  local -r hash_file_contents="53ed1a3149454b8d2825ac0caa9e57f81282241f9180a397b4a9c321aa36d366  stroom_core_test-v7.0-beta.192.tar.gz"
