...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.0.21/stroom-stacks-v6.0-beta.28-9/; s/v7.0.21/v6.0-beta.28-9/; s/fa2aba08247178543f6c1bc99016103e44d0eb47c5479c8022a9c18fbdb6efc1  stroom_core_test-v7.0.21.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.0.21"
  local -r stack_version="v7.0.21"
  local -r hash_file_contents="fa2aba08247178543f6c1bc99016103e44d0eb47c5479c8022a9c18fbdb6efc1  stroom_core_test-v7.0.21.tar.gz"
