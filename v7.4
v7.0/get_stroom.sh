...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.4-beta.7-proxy-v7.0.32-2/stroom-stacks-v6.0-beta.28-9/; s/v7.4-beta.7-proxy-v7.0.32-2/v6.0-beta.28-9/; s/2f7469937fe76f443a859896c169547acb679e8157447c2ff485cb67587be172  stroom_core_test-v7.4-beta.7-proxy-v7.0.32-2.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.4-beta.7-proxy-v7.0.32-2"
  local -r stack_version="v7.4-beta.7-proxy-v7.0.32-2"
  local -r hash_file_contents="2f7469937fe76f443a859896c169547acb679e8157447c2ff485cb67587be172  stroom_core_test-v7.4-beta.7-proxy-v7.0.32-2.tar.gz"
