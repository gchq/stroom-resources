...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.13-beta.16/stroom-stacks-v6.0-beta.28-9/; s/v7.13-beta.16/v6.0-beta.28-9/; s/9211a22d8d2aff92b3831c4c0d8cdeedb5a2fddfc05ef2171f59e5987ea611d6  stroom_core_test-v7.13-beta.16.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.13-beta.16"
  local -r stack_version="v7.13-beta.16"
  local -r hash_file_contents="9211a22d8d2aff92b3831c4c0d8cdeedb5a2fddfc05ef2171f59e5987ea611d6  stroom_core_test-v7.13-beta.16.tar.gz"
