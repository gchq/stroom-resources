...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.13-beta.6/stroom-stacks-v6.0-beta.28-9/; s/v7.13-beta.6/v6.0-beta.28-9/; s/8a3079ff5b79a749707a8c724b3dfe6066a34ac698a64ac42ab0c1aabc363e5e  stroom_core_test-v7.13-beta.6.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.13-beta.6"
  local -r stack_version="v7.13-beta.6"
  local -r hash_file_contents="8a3079ff5b79a749707a8c724b3dfe6066a34ac698a64ac42ab0c1aabc363e5e  stroom_core_test-v7.13-beta.6.tar.gz"
