...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.13-beta.11/stroom-stacks-v6.0-beta.28-9/; s/v7.13-beta.11/v6.0-beta.28-9/; s/31d962155e167e4449f28cfe32b9d0c309c9a2d03304ff83fa76475a9e51d887  stroom_core_test-v7.13-beta.11.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.13-beta.11"
  local -r stack_version="v7.13-beta.11"
  local -r hash_file_contents="31d962155e167e4449f28cfe32b9d0c309c9a2d03304ff83fa76475a9e51d887  stroom_core_test-v7.13-beta.11.tar.gz"
