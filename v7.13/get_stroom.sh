...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.13-beta.13/stroom-stacks-v6.0-beta.28-9/; s/v7.13-beta.13/v6.0-beta.28-9/; s/f705e5e3caedc42a56dae305a28cf382dbbced8a915f08577b246f6998c96f61  stroom_core_test-v7.13-beta.13.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.13-beta.13"
  local -r stack_version="v7.13-beta.13"
  local -r hash_file_contents="f705e5e3caedc42a56dae305a28cf382dbbced8a915f08577b246f6998c96f61  stroom_core_test-v7.13-beta.13.tar.gz"
