...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v6.1.32/stroom-stacks-v6.0-beta.28-9/; s/v6.1.32/v6.0-beta.28-9/; s/80846988252f4fcee5e8def87e8608dc40d2e47b724c40c39e097195403c5395  stroom_core_test-v6.1.32.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v6.1.32"
  local -r stack_version="v6.1.32"
  local -r hash_file_contents="80846988252f4fcee5e8def87e8608dc40d2e47b724c40c39e097195403c5395  stroom_core_test-v6.1.32.tar.gz"
