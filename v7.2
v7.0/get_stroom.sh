...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.2.14-proxy-v7.0.32/stroom-stacks-v6.0-beta.28-9/; s/v7.2.14-proxy-v7.0.32/v6.0-beta.28-9/; s/3a2fa0329d0c505fe749e900b84547d2f981f5691fcea2397c312daf3ffe07a1  stroom_core_test-v7.2.14-proxy-v7.0.32.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.2.14-proxy-v7.0.32"
  local -r stack_version="v7.2.14-proxy-v7.0.32"
  local -r hash_file_contents="3a2fa0329d0c505fe749e900b84547d2f981f5691fcea2397c312daf3ffe07a1  stroom_core_test-v7.2.14-proxy-v7.0.32.tar.gz"
