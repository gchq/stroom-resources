...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.2.10-proxy-v7.0.32/stroom-stacks-v6.0-beta.28-9/; s/v7.2.10-proxy-v7.0.32/v6.0-beta.28-9/; s/8936d1bff0d24abaa64c145095353686054a43ec8c5603da055773334ae687f0  stroom_core_test-v7.2.10-proxy-v7.0.32.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.2.10-proxy-v7.0.32"
  local -r stack_version="v7.2.10-proxy-v7.0.32"
  local -r hash_file_contents="8936d1bff0d24abaa64c145095353686054a43ec8c5603da055773334ae687f0  stroom_core_test-v7.2.10-proxy-v7.0.32.tar.gz"
