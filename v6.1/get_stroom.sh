...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v6.1.32-2/stroom-stacks-v6.0-beta.28-9/; s/v6.1.32-2/v6.0-beta.28-9/; s/a98d5243c211ef5f9c2b5df0175d0c37c63d3eb9f99f2f1feb0b87d73d7ce5e6  stroom_core_test-v6.1.32-2.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v6.1.32-2"
  local -r stack_version="v6.1.32-2"
  local -r hash_file_contents="a98d5243c211ef5f9c2b5df0175d0c37c63d3eb9f99f2f1feb0b87d73d7ce5e6  stroom_core_test-v6.1.32-2.tar.gz"
