...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.12.10/stroom-stacks-v6.0-beta.28-9/; s/v7.12.10/v6.0-beta.28-9/; s/6b02b8ee3e313d53fc81537e769d1361a54a293d18450ca8af491a5811fe515a  stroom_core_test-v7.12.10.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.12.10"
  local -r stack_version="v7.12.10"
  local -r hash_file_contents="6b02b8ee3e313d53fc81537e769d1361a54a293d18450ca8af491a5811fe515a  stroom_core_test-v7.12.10.tar.gz"
