...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.12.12/stroom-stacks-v6.0-beta.28-9/; s/v7.12.12/v6.0-beta.28-9/; s/9cdd04a676cea19187f24121f0875483266326f57f69b6419fb394f694917424  stroom_core_test-v7.12.12.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.12.12"
  local -r stack_version="v7.12.12"
  local -r hash_file_contents="9cdd04a676cea19187f24121f0875483266326f57f69b6419fb394f694917424  stroom_core_test-v7.12.12.tar.gz"
