...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v7.12.8/stroom-stacks-v6.0-beta.28-9/; s/v7.12.8/v6.0-beta.28-9/; s/ed149c192a287cf0dac38dce6113c198507940827a0b90ddec3b310be0c0e6aa  stroom_core_test-v7.12.8.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v7.12.8"
  local -r stack_version="v7.12.8"
  local -r hash_file_contents="ed149c192a287cf0dac38dce6113c198507940827a0b90ddec3b310be0c0e6aa  stroom_core_test-v7.12.8.tar.gz"
